 ...
 * date: 04/05/2018
 * file name: PieceManagementOptions.xaml.cs
 * version: 1.0
 */
namespace InRealLife_2
{
    ...
    /// </summary>
    public partial class PieceManagementOptions : Page
    {
        //
        public PieceManagementOptions()
        {
            InitializeComponent();
        }

        //
        private void BtnManageScenarios_Click(object sender, RoutedEventArgs e)
        {
        ...
        //
        private void BtnManageStages_Click(object sender, RoutedEventArgs e)
        {
            // call appropriate menu
